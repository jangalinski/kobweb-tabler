...
object SiteIcons {
  /**
   * GitHub brand icon used for outbound repository links.
   */
  val Github = Image.InlineSvg(
    svg = """
  ...
  /**
   * Analysis icon used in the main navigation.
   */
  val Analyse = Image.InlineSvg(
    svg = """
  ...
  /**
   * Liga icon used in the main navigation.
   */
  val Liga = Image.InlineSvg(
    svg = """
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        <path d="M8 4h8v2a4 4 0 0 1 -8 0z" />
        <path d="M6 4h12v2a6 6 0 0 1 -12 0z" />
        <path d="M10 16h4" />
        <path d="M9 20h6" />
      </svg>
    """.trimIndent(),
